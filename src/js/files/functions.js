...
// Запись в sessionStorrage массивов
// 1. Изначально создаем массив, добавляем его в storrage с помощью saveArrStorrage(arr, name).
// 2. Далее добавляем в данный массив номера с помощью addNumberStorrage(name, number)
...
// Перемешиваем массив. Возвращаем новый пеермешанный массив
